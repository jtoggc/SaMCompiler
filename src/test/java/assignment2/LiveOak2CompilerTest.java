...
import main.java.assignment2.LiveOak2Compiler;
...
class LiveOak2CompilerTest {
    ...
    @Test
    @DisplayName("Testing simple addition for LO-0; should return 11")
    void testLO0_01() throws Throwable {
        String fileName = Path.of(lo2ValidProgramDir, "test_simple_add.lo").toString();
        String program = LiveOak2Compiler.compiler(fileName);
        test.java.assignment2.SamTestRunner.checkReturnValue(program, 11);
    }
    ...
    void testLO2_30() throws Throwable {
        ...
        String program = LiveOak2Compiler.compiler(fileName);
        test.java.assignment2.SamTestRunner.checkReturnValue(program, 120);
    }
